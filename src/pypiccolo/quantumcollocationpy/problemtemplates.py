...
class QuantumStateSmoothPulseProblem(QuantumControlProblem):
    def __init__(
        ...
        **kwargs,
        ...
        self.value = get_global(mod_pic, 'QuantumStateSmoothPulseProblem')(self.system.value, self.states_init, self.states_goal, self.T, self.dt)
...
class UnitarySmoothPulseProblem(QuantumControlProblem):
    def __init__(
        ...
        **kwargs,
        ...
        self.value = get_global(mod_pic, 'UnitarySmoothPulseProblem')(self.system.value, self.operator, JuliaInt(T), JuliaFloat(dt))
...
class UnitaryMinimumTimeProblem(QuantumControlProblem):
    def __init__(
        ...
        fn = get_global(mod_pic, 'UnitaryMinimumTimeProblem')
        ...
        # self.value = get_global(mod_pic, 'UnitaryMinimumTimeProblem')(self.prob.value, self.system.value)
